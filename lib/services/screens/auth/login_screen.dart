...
import 'admin_otp_verification_screen.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _onVerifyOtp() async {
    ...
    try {
      ...
      _msg(e.code == 'invalid-verification-code'
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: const Color(0xFF7B1F3F).withOpacity(0.3)),
          ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.admin_panel_settings_outlined,
                  size: 16, color: const Color(0xFF7B1F3F)),
        ...
        Container(
          ...
          child: const Icon(Icons.shield_outlined,
              color: Color(0xFF7B1F3F), size: 36),
        ),
        const SizedBox(height: 16),
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    ...
                    borderSide: const BorderSide(
                        color: Color(0xFF7B1F3F), width: 2),
                  ),
                ),
                onChanged: (val) {
